...
var centerMenu = [
    ...
    ,{
        name: '签到',
        url: '../qiandao/list.html'
    }
    ,{
        name: '作业提交',
        url: '../zuoyeTijiao/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/dangyaunxuexijiaoliupingtai/admin/dist/index.html#/login";
